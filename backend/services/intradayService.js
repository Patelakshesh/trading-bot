...
const SECTOR_MAPPING = {
    ...
    'BAJFINANCE.NS': '^NSEBANK', 'BAJAJFINSV.NS': '^NSEBANK', 'INDUSINDBK.NS': '^NSEBANK', 'SBILIFE.NS': '^NSEBANK', 'HDFCLIFE.NS': '^NSEBANK', 'FEDERALBNK.NS': '^NSEBANK', 'IDFCFIRSTB.NS': '^NSEBANK', 'AUBANK.NS': '^NSEBANK', 'ABCAPITAL.NS': '^NSEBANK', 'M&MFIN.NS': '^NSEBANK',
    'TATUMOTORS.NS': '^CNXAUTO', 'M&M.NS': '^CNXAUTO', 'MARUTI.NS': '^CNXAUTO', 'EICHERMOT.NS': '^CNXAUTO', 'HEROMOTOCO.NS': '^CNXAUTO', 'BAJAJ-AUTO.NS': '^CNXAUTO', 'TVSMOTOR.NS': '^CNXAUTO', 'ASHOKLEY.NS': '^CNXAUTO', 'CUMMINSIND.NS': '^CNXAUTO',
    ...
    'SUNPHARMA.NS': '^CNXPHARMA', 'CIPLA.NS': '^CNXPHARMA', 'DRREDDY.NS': '^CNXPHARMA', 'APOLLOHOSP.NS': '^CNXPHARMA', 'DIVISLAB.NS': '^CNXPHARMA', 'TORNTFARM.NS': '^CNXPHARMA', 'LUPIN.NS': '^CNXPHARMA', 'AUROPHARMA.NS': '^CNXPHARMA',
