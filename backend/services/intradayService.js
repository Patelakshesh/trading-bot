...
const NIFTY_100_SYMBOLS = [
    ...
    'KPITTECH.NS', 'CYIENT.NS', 'SONACOMS.NS', 'ZENSARTECH.NS', 'BIRLASOFT.NS', 'TANLA.NS', 'HAPPSTMNDS.NS',
...
const SECTOR_MAPPING = {
    'TCS.NS': '^CNXIT', 'INFY.NS': '^CNXIT', 'WIPRO.NS': '^CNXIT', 'HCLTECH.NS': '^CNXIT', 'TECHM.NS': '^CNXIT', 'LTIM.NS': '^CNXIT', 'PERSISTENT.NS': '^CNXIT', 'COFORGE.NS': '^CNXIT', 'MPHASIS.NS': '^CNXIT', 'KPITTECH.NS': '^CNXIT', 'CYIENT.NS': '^CNXIT', 'ZENSARTECH.NS': '^CNXIT', 'BIRLASOFT.NS': '^CNXIT', 'TANLA.NS': '^CNXIT', 'HAPPSTMNDS.NS': '^CNXIT',
    ...
    'ITC.NS': '^CNXFMCG', 'HINDUNILVR.NS': '^CNXFMCG', 'BRITANNIA.NS': '^CNXFMCG', 'TATACONSUM.NS': '^CNXFMCG', 'DABUR.NS': '^CNXFMCG', 'GODREJCP.NS': '^CNXFMCG', 'MARICO.NS': '^CNXFMCG', 'PAGEIND.NS': '^CNXFMCG', 'KALYANKJIL.NS': '^CNXFMCG',
