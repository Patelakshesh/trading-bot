...
const SECTOR_MAPPING = {
    'TCS.NS': '^CNXIT', 'INFY.NS': '^CNXIT', 'WIPRO.NS': '^CNXIT', 'HCLTECH.NS': '^CNXIT', 'TECHM.NS': '^CNXIT', 'LTIM.NS': '^CNXIT', 'PERSISTENT.NS': '^CNXIT', 'COFORGE.NS': '^CNXIT', 'MPHASIS.NS': '^CNXIT', 'KPITTECH.NS': '^CNXIT', 'CYIENT.NS': '^CNXIT', 'ZENSARTECH.NS': '^CNXIT', 'BIRLASOFT.NS': '^CNXIT', 'TANLA.NS': '^CNXIT', 'HAPPSTMNDS.NS': '^CNXIT', 'KAYNES.NS': '^CNXIT', 'NETWEB.NS': '^CNXIT', 'TEJASNET.NS': '^CNXIT', 'MAPMYINDIA.NS': '^CNXIT', 'AFFLE.NS': '^CNXIT', 'ROUTE.NS': '^CNXIT', 'POLICYBZR.NS': '^CNXIT', 'NYKAA.NS': '^CNXIT',
    ...
    'TATUMOTORS.NS': '^CNXAUTO', 'M&M.NS': '^CNXAUTO', 'MARUTI.NS': '^CNXAUTO', 'EICHERMOT.NS': '^CNXAUTO', 'HEROMOTOCO.NS': '^CNXAUTO', 'BAJAJ-AUTO.NS': '^CNXAUTO', 'TVSMOTOR.NS': '^CNXAUTO', 'ASHOKLEY.NS': '^CNXAUTO', 'CUMMINSIND.NS': '^CNXAUTO', 'BALKRISIND.NS': '^CNXAUTO', 'APOLLOTYRE.NS': '^CNXAUTO', 'BHARATFORG.NS': '^CNXAUTO', 'SONACOMS.NS': '^CNXAUTO',
    'RELIANCE.NS': '^CNXENERGY', 'NTPC.NS': '^CNXENERGY', 'POWERGRID.NS': '^CNXENERGY', 'COALINDIA.NS': '^CNXENERGY', 'ONGC.NS': '^CNXENERGY', 'BPCL.NS': '^CNXENERGY', 'GAIL.NS': '^CNXENERGY', 'IREDA.NS': '^CNXENERGY', 'SJVN.NS': '^CNXENERGY', 'NHPC.NS': '^CNXENERGY', 'CESC.NS': '^CNXENERGY', 'INOXWIND.NS': '^CNXENERGY',
    'ITC.NS': '^CNXFMCG', 'HINDUNILVR.NS': '^CNXFMCG', 'BRITANNIA.NS': '^CNXFMCG', 'TATACONSUM.NS': '^CNXFMCG', 'DABUR.NS': '^CNXFMCG', 'GODREJCP.NS': '^CNXFMCG', 'MARICO.NS': '^CNXFMCG', 'PAGEIND.NS': '^CNXFMCG', 'KALYANKJIL.NS': '^CNXFMCG', 'CHALET.NS': '^CNXFMCG', 'EIDPARRY.NS': '^CNXFMCG', 'FACT.NS': '^CNXFMCG', 'RENUKA.NS': '^CNXFMCG',
    'SUNPHARMA.NS': '^CNXPHARMA', 'CIPLA.NS': '^CNXPHARMA', 'DRREDDY.NS': '^CNXPHARMA', 'APOLLOHOSP.NS': '^CNXPHARMA', 'DIVISLAB.NS': '^CNXPHARMA', 'TORNTFARM.NS': '^CNXPHARMA', 'LUPIN.NS': '^CNXPHARMA', 'AUROPHARMA.NS': '^CNXPHARMA', 'ABBOTINDIA.NS': '^CNXPHARMA', 'ALKEM.NS': '^CNXPHARMA', 'LAURUSLABS.NS': '^CNXPHARMA', 'BIOCON.NS': '^CNXPHARMA', 'METROPOLIS.NS': '^CNXPHARMA', 'LALPATHLAB.NS': '^CNXPHARMA', 'GRANULES.NS': '^CNXPHARMA', 'GLENMARK.NS': '^CNXPHARMA',
